...
;!function () {
    ...
    var e = window.layui && layui.define, t = {
            getPath: function () {
                ...
                if (n.path) {
                    ...
                    o.rel = "stylesheet", o.href = n.path + e, o.id = l, document.getElementById(l) || r.appendChild(o), "function" == typeof a && !function c() {
                        return ++d > 80 ? window.console && console.error(": Invalid") : void(1989 === parseInt(t.getStyle(document.getElementById(l), "width")) ? a() : setTimeout(c, 100))
                    }()
                }
            }
        }, n = {
            ...
            ready: function (a) {
                var i = "laydate", r = "", o = (e ? "modules/laydate/" : "theme/") + "default/?v=" + n.v + r;
